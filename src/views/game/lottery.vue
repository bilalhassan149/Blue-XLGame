<template>
  <div class="game_container">
    <div class="game_text">
      ...
      <div style="font-size: 50px">LOTTERY</div>
      <div style="font-size: 20px; width: 518px; color: black">
        {{ $en("games.sports_text") }}
      </div>
      <img
        src="../../assets/image/lottery/lotterySponsors.png"
        style="height: 60px; width: 296px"
    ...
    <img class="char" src="../../assets/image/lottery/lotteryChar.png" />
  </div>
</template>
